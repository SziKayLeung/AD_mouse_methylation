...
# pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/J20_PCA.pdf")
...
# head(res)
# 
# write.csv(res,"/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/MixedModelResults_J20.csv")
####################
...
write.csv(res,"/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/MixedModelResultswPathology_J20.csv")
