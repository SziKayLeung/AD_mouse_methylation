# title: RRBS - BiSeq rTg4510 - Differentially Methylated Positions (DMPs) - ~Pathology
...
# Beta regression ~Genotype + Age + Pathology
...
save(betaResultsPathology,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/rTg4510_betaResultsDMPsPathology.RData")
write.csv(betaResultsPathology,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/rTg4510_betaResultsDMPsPathology.csv")
...
write.csv(stats_table,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/rTg4510/DMPsPathology_stats_table_rTg4510.csv")

sig_pathology <- stats_table[which(stats_table[,"FDR_adj_pathology"] < 0.05),]
nrow(sig_pathology)
write.csv(sig_pathology,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/rTg4510/DMPsPathology_rTg4510_sig_pathology.csv")
