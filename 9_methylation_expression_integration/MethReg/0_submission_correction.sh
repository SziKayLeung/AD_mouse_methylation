...
#SBATCH --output=MethRegOutput/methRegPromoterTg4510Correction-%A_%a.o
#SBATCH --error=MethRegOutput/methRegPromoterTg4510Correction-%A_%a.e
...
Rscript ${scriptDir}/run_methreg_unsupervised_correction.R -c ${Chr}