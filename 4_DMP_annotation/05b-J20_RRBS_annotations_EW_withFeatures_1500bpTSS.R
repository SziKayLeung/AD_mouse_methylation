...
# This script annotates the RRBS data using the "Function_annotateRRBS.r" function
...
# title: "RRBS - BiSeq J20 - 'Full' Annotations"
...
temp <- list.files("/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMRs/J20", full.names = T, pattern = ".csv")
temp2 <- gsub('.{4}$', '', list.files("/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMRs/J20", pattern = ".csv"))
...
for(i in 1:length(temp)){
  ...
  #write csv file
  outpath <- paste0("/gpfs/ts0/projects/Research_Project-191406/EmmaW/RRBSAnnotatedResults/J20/DMRs/", temp2[i], "_1500bptssAnno.csv")
...
temp <- list.files("/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20", full.names = T)
temp2 <- gsub('.{4}$', '', list.files("/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20", pattern = ".csv"))
...
for(i in 1:length(temp)){
  ...
  outpath <- paste0("/gpfs/ts0/projects/Research_Project-191406/EmmaW/RRBSAnnotatedResults/J20/DMPs/", temp2[i], "_1500bptssAnno.csv")
  write.csv(out, file = outpath)
