# title: RRBS - BiSeq J20 - Differentially Methylated Positions (DMPs) - ~ Genotype + Age + Genotype*Age
...
save(betaResultsInteraction,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/J20_betaResultsDMPsInteraction.RData")
write.csv(betaResultsInteraction,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/J20_betaResultsDMPsInteraction.csv")
...
write.csv(stats_table,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20/DMPsInteractionModel_stats_table_J20.csv")

sig_genotype <- stats_table[which(stats_table[,"FDR_adj_genotype"] < 0.05),]
nrow(sig_genotype)
write.csv(sig_genotype,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20/DMPsInteractionModel_J20_sig_genotype.csv")

sig_age <- stats_table[which(stats_table[,"FDR_adj_age"] < 0.05),]
nrow(sig_age)
write.csv(sig_age,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20/DMPsInteractionModel_J20_sig_age.csv")

sig_interaction <- stats_table[which(stats_table[,"FDR_adj_interaction"] < 0.05),]
nrow(sig_interaction)
write.csv(sig_interaction,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMPs/J20/DMPsInteractionModel_J20_sig_interaction.csv")
