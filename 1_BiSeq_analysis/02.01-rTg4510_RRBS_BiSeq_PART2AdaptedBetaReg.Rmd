---
title: "RRBS - BiSeq rTg4510 Part 2 - Adapted Beta Regression"
...
# load(file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseq_rTg4510.RData") # complete file
load(file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseq_predictedMeth_rTg4510.RData") # predictedMeth
load(file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/RRBS/biseqBetaResults_rTg4510.RData")
...
# 
# save(betaResults, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/RRBS/biseqBetaResults_rTg4510.RData")
...
# # predictedMethNull <- predictedMeth[,46:61] # Age and Genotype selected are random to not group based on genotype or age - we selected 16 for 2 genotype, 4 time points and repeated twice to increase randomness
...
#       file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/RRBS/biseqBetaResultsNull_rTg4510.RData")

```

```{r}
# Load the previous chunk betaResultsNull rdat object. Also print the samples used to generate the betaResultsNull
load("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/RRBS/biseqBetaResultsNull_rTg4510.RData")
print(colData(predictedMethNull))
```
...
load("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/RRBS/biseqBetaResults_rTg4510.RData")
...
write.csv(DMRsGenotype,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMRs/rTg4510/DMRsGenotype.csv")

DMRsGenotype <- DMRs
save(betaResultsGenotype, DMRsGenotype,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqResultsGenotype_rTg4510.RData")
```
...
write.csv(DMRsInteraction,
          file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMRs/rTg4510/DMRsInteraction.csv")

DMRsInteraction <- DMRs
save(betaResultsInteraction, DMRsInteraction,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqResultsInteraction_rTg4510.RData")
```
