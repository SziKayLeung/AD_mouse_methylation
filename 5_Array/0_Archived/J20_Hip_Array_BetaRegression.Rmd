---
title: "J20 Hippocampus Array Beta Regression Results"
output: 
  html_document:
    code_folding: hide
    toc: true
...
#                            link = "probit")
# 
# resave(betaResultsChip, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/ArrayBetaRegResults_J20_HIP.RData")
```
...
# write.csv(betaResults, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_stats_table_J20_HIP.csv")
# 
# 
# sig_genotype <- betaResults[which(betaResults[,"FDR_adj_genotype"] < 0.05),]
# write.csv(sig_genotype, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_J20_HIP_sig_genotype.csv")
# 
# sig_age <- betaResults[which(betaResults[,"FDR_adj_age"] < 0.05),]
# write.csv(sig_age, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_J20_HIP_sig_age.csv")
# 
# sig_interaction <- betaResults[which(betaResults[,"FDR_adj_Interaction"] < 0.05),]
# write.csv(sig_interaction, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_J20_HIP_sig_interaction.csv")
...
pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/J20_HIP_Genotype.pdf", onefile = T)
for(i in 1:6){
  plotDMPGenotype(cpg = rownames(betaResults[i,]) , color = color_J20_TG, betaResults = betaResults,
                   betas = betas, pheno = pheno)
}
...
pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/J20_HIP_Interaction.pdf", onefile = T)
for(i in 1:6){
  plotDMPInteraction(cpg = rownames(betaResults[i,]) , color = color_J20_TG, betaResults = betaResults,
                   betas = betas, pheno = pheno)
}
...
#                                                      link = "probit")
# resave(betaResultsPathology, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/ArrayBetaRegResults_J20_HIP.RData")
```
...
pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/J20_HIP_Pathology.pdf", onefile = T)
for(i in 1:6){
  plotDMPPathology(cpg = rownames(betaResults[i,]) , color = color_J20_TG, betaResults = betaResults,
                   betas = betas, pheno = pheno)
}
...
#save outputs
# 
# write.csv(betaResults, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_stats_table_J20_HIP_Pathology.csv")
# 
# 
# sig_pathology <- betaResults[which(betaResults[,"FDR_adj_pathology"] < 0.05),]
# write.csv(sig_pathology, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_J20_HIP_sig_pathology.csv")
...
#                            pheno = pheno,
#                            formula = ~Genotype + Age_months+ Pathology_HIP + Chip_ID,
#                            link = "probit")
# 
# save(betaResultsChip, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/ArrayBetaRegResultsFull_J20_HIP.RData")
...
load("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/ArrayBetaRegResultsFull_J20_HIP.RData")
betaResults <- betaResultsChip
# Add chr and bp before deleting rows
Chr <- species_probes$Chr[match(species_probes$probeID, betaResults[,"cpg"])]
Bp <- species_probes$Bp[match(species_probes$probeID, betaResults[,"cpg"])]
...
pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/FullJ20_HIP_Genotype.pdf", onefile = T)
for(i in 1:6){
  plotDMPGenotype(cpg = rownames(betaResults[i,]) , color = color_J20_TG, betaResults = betaResults,
                   betas = betas, pheno = pheno)
}
...
pdf("/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/FullJ20_HIP_Pathology.pdf", onefile = T)
for(i in 1:6){
  plotDMPPathology(cpg = rownames(betaResults[i,]) , color = color_J20_TG, betaResults = betaResults,
                   betas = betas, pheno = pheno)
}
...
write.csv(betaResults, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_stats_table_FullJ20_HIP.csv")


sig_genotype <- betaResults[which(betaResults[,"FDR_adj_genotype"] < 0.05),]
write.csv(sig_genotype, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_FullJ20_HIP_sig_genotype.csv")

sig_age <- betaResults[which(betaResults[,"FDR_adj_age"] < 0.05),]
write.csv(sig_age, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_FullJ20_HIP_sig_age.csv")

sig_pathology <- betaResults[which(betaResults[,"FDR_adj_pathology"] < 0.05),]
write.csv(sig_pathology, file = "/gpfs/ts0/projects/Research_Project-191406/Aisha/data/Array/DMPs_FullJ20_HIP_sig_interaction.csv")
