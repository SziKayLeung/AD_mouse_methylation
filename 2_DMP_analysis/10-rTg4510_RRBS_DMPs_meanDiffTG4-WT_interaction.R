...
DMPs <- read.csv("/lustre/projects/Research_Project-191406/isabel/RRBS_new/DMPs/rTg4510/DMPsInteractionModel_rTg4510_sig_interaction.csv",
...
save(DatFrame,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/rTg4510_DMPsInteraction_meanDiffTG-WT.RData")
