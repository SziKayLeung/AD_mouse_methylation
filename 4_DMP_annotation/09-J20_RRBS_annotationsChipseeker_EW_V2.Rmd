...
setwd("/gpfs/ts0/projects/Research_Project-191406/EmmaW/ChipSeekerPlots/J20/DMRs/")
...
pdf(paste0("J20AnnoPie_", temp2[i], ".pdf"))
pie <- plotAnnoPie(peakAnno)
print(pie)
dev.off()

pdf(paste0("J20AnnoBar_", temp2[i], ".pdf"))
bar <- plotAnnoBar(peakAnno)
print(bar)
dev.off()

pdf(paste0("J20AggrPlot_", temp2[i], ".pdf"))
...
setwd("/gpfs/ts0/projects/Research_Project-191406/EmmaW/ChipSeekerPlots/J20/DMPs/")
