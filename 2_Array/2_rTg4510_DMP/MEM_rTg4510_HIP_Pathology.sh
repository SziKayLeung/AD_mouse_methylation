...
#SBATCH --job-name=Tg_HIP_Pathology
...
Rscript "/gpfs/ts0/projects/Research_Project-191406/EmmaW/Array/MixedModelsEffectBetaReg_rTg4510_HIP_Pathology_EW.R"  ## execute R script
