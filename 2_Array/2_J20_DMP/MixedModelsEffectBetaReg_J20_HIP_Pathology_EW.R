...
testCpG<-function(row, phenoJ20_HIP){
  ...
  modelglmm<-glmmTMB(betasJ20_HIP[i,] ~ Pathology + Chip_ID, data=phenoJ20_HIP, REML = FALSE, family=beta_family(link = "probit"))
...
write.csv(res,"/gpfs/ts0/projects/Research_Project-191406/EmmaW/Array/Results/MixedModelResultsHIP_Pathology_J20.csv")
