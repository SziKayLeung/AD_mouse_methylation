...
## 11/06/2024: run DMP analysis using BiSeq for J20 model
...
phenotype$J20 <- phenotype$J20[colnames(RRBS_smoothbetas),]
...
save(betaResultsClean, file = paste0(dirnames$differential, "/rrbs/J20_betaResultsDMP_GenotypeInteraction.RData"))
...
save(J20_rrbs_DMP, file = paste0(dirnames$differential, "/rrbs/J20_sigResultsDMP_GenotypeInteraction.RData"))
