...
# pathologyModel <- Pathology + Chip_ID
# Hippocampus only
...
testCpG<-function(row, phenoTg_HIP){
  ...
  modelglmm<-glmmTMB(betasTg_HIP[i,] ~ Pathology + Chip_ID, data=phenoTg_HIP, REML = FALSE, family=beta_family(link = "probit"))
...
write.csv(res,"/gpfs/ts0/projects/Research_Project-191406/EmmaW/Array/Results/rTg4510/MixedModelResultsHIP_Pathology_rTg4510.csv")
