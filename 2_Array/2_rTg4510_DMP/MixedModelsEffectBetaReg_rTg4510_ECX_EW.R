...
testCpG<-function(row, phenoTg_ECX){
  ...
  modelglmm<-glmmTMB(betasTg_ECX[i,] ~ Genotype + Age_months + Genotype*Age_months + Chip_ID, data=phenoTg_ECX, REML = FALSE, family=beta_family(link = "probit"))
...
write.csv(res,"/gpfs/ts0/projects/Research_Project-191406/EmmaW/Array/Results/MixedModelResultsECX_rTg4510.csv")
