---
title: "RRBS - BiSeq rTg4510 Part 2 - Beta Regression - Pathology"
...
save(betaResults, file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqBetaResultsPathology_rTg4510.RData")
```
...
#       file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqBetaResultsNull_rTg4510.RData")

```

```{r}
# Load the previous chunk betaResultsNull rdat object. Also print the samples used to generate the betaResultsNull
load("/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqBetaResultsNull_rTg4510.RData")
print(colData(predictedMethNull))
```
...
write.csv(DMRsPathology, file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/DMRs/rTg4510/DMRsPathology.csv")

DMRsPathology <- DMRs
save(betaResultsPathology, DMRsPathology,
     file = "/gpfs/ts0/projects/Research_Project-191406/isabel/RRBS_new/biseqResultsPathology_rTg4510.RData")
```