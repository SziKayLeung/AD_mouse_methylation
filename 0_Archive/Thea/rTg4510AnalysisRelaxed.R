# rTg4510 Analysis with more relaxed NA filtering 
...
RRBS<-RRBSFiltering(RRBSmatrix, RDThreshold = 10,  groupPheno, sampleMin = 6, 
                    densityPlots=TRUE,
                    pdfFileName = "rTg4510RelaxedDensityPlots.pdf",
                    SDThreshold = 5,
                    covCols=FALSE)

setwd("/mnt/data1/Thea/IsabelSamples/data")
save(RRBS, file="rTg4510MatrixRelaxedFiltered.Rdata")
...
# load filtered data
setwd("/mnt/data1/Thea/IsabelSamples/data/")
load("rTg4510MatrixRelaxedFiltered.Rdata")
...
# save results
setwd("/mnt/data1/Thea/IsabelSamples/data")
save(rTg4510stats,file="rTg4510Relaxedstats.Rdata")
